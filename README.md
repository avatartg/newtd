# newtd *:)* #به نام خدا این سورس تیم ایست هست برای کسایکه بلد نیستن اجراش کنن ساختیم کدارو به ترتیب اجرا کنید #سوالی بود تلگرام.  مسیج بدید @ThisisAlisudo tnx;)💢 سیستم عامل فقط باید اوبنتو 16 ، 64 بیت باشه
